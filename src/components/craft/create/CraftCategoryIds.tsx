      ...
      <div className="col-span-2 sm:col-span-1 flex flex-col">
        ...
        <div>
          {unselectedCategory.length > 0 ? (
            <select
              id="opcionesC"
              className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-1/3 p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
            >
      ...
      <div className="col-span-2 sm:col-span-1 flex flex-col">
        ...
        <ul className="flex flex-wrap">
          {SelectedCategory.sort((a, b) => a.Name.localeCompare(b.Name)).map(
            (category, index) => (
              <span
                className="bg-blue-100 text-blue-800 text-xs font-medium me-2 mb-3 px-2.5 py-0.5 rounded-full dark:bg-blue-900 dark:text-blue-300 flex-col"
                key={index}
              >
                {category.Name}
                <button
